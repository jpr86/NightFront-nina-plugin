...
namespace JeffRidder.NINA.Nightfront {
    ...
    /// The user interface for the settings will be defined by a DataTemplate with the key having the naming convention "Nightfront_Options" where Nightfront corresponds to the AssemblyTitle - In this template example it is found in the Options.xaml
    /// </summary>
    ...
    public class Nightfront : PluginBase, INotifyPropertyChanged {
        ...
        private readonly ImagePattern exampleImagePattern = new ImagePattern("$$EXAMPLEPATTERN$$", "An example of an image pattern implementation", "NightFront");

        [ImportingConstructor]
        public Nightfront(IProfileService profileService, IOptionsVM options, IImageSaveMediator imageSaveMediator) {
