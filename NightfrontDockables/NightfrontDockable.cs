...
namespace JeffRidder.NINA.Nightfront.NightfrontDockables {
    /// <summary>
    ...
    public class NightfrontDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public NightfrontDockable(
            ...
            dict.Source = new Uri("JeffRidder.NINA.Nightfront;component/NightfrontDockables/NightfrontDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["JeffRidder.NINA.Nightfront_AltitudeSVG"];
