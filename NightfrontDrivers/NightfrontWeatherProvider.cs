...
namespace JeffRidder.NINA.Nightfront.NightfrontDrivers {
    /// <summary>
    ...
    public class NightfrontWeatherProvider : IEquipmentProvider<IWeatherData> {
        private IProfileService profileService;

        [ImportingConstructor]
        public NightfrontWeatherProvider(IProfileService profileService) {
            this.profileService = profileService;
        }

        public string Name => "Nightfront";

        public IList<IWeatherData> GetEquipment() {
            var devices = new List<IWeatherData>();
            devices.Add(new NightfrontWeatherDriver("MyUniqueId", "MyDeviceId"));
