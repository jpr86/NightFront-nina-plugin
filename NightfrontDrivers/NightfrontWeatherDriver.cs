...
namespace JeffRidder.NINA.Nightfront.NightfrontDrivers {
    ...
    /// </summary>
    public class NightfrontWeatherDriver : BaseINPC, IWeatherData {
        public NightfrontWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"Nightfront Weather Data ({deviceId})";
        ...
        public string Category => "Nightfront Weather Driver";
